//
//  ClassedItemListViewController.swift
//  havings
//
//  Created by Tatsuhiko Shimomura on 2016/09/14.
...
class ClassedItemListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.reloadClassedItems(0, callback: {})
        
        self.title = String(format: NSLocalizedString("Prompt.ClassedTagItem", comment: ""), tagName)
    ...
    func reloadClassedItems(page: Int, callback: () -> Void){
        self.loadingNextItem = true
        API.call(Endpoint.Item.GetClassedItem(tagId: self.tagId, page: page)) { response in
...
extension ClassedItemListViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func scrollViewDidScroll(scrollView: UIScrollView) {
        ...
        if reachBottom {
            ...
            if nextItem && !loadingNextItem {
                ...
                self.reloadClassedItems((self.parentItem.nextPageForItem ?? 0), callback: {
...
extension ClassedItemListViewController: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    func imageForEmptyDataSet(scrollView: UIScrollView!) -> UIImage! {
        return UIImage(named: "icon_type_item")
    }
    
    func titleForEmptyDataSet(scrollView: UIScrollView!) -> NSAttributedString! {
        let text: String = NSLocalizedString("Prompt.User.Item.Empty", comment: "")
