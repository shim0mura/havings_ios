...
SWIFT_CLASS("_TtC18XLActionController10ActionCell")
@interface ActionCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Nullable actionTitleLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Nullable actionImageView;
@property (nonatomic, weak) IBOutlet UILabel * _Nullable actionDetailLabel;
@property (nonatomic, weak) IBOutlet UIView * _Nullable separatorView;
...
SWIFT_CLASS("_TtC18XLActionController31DynamicCollectionViewFlowLayout")
...
- (UICollectionViewLayoutAttributes * _Nullable)layoutAttributesForItemAtIndexPath:(NSIndexPath * _Nullable)indexPath;
